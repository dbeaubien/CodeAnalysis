...
// CHART_Area_AddNumberedValues (ChartID; ValuesArray; NumbersArray; lineColour)
// CHART_Area_AddNumberedValues (longint; Ptr To Real Array; Ptr to Number Array; text)
// 
// DESCRIPTION
...
C_POINTER:C301($3; $vp_al_valuesArrayPtr)
...
If (DEV_ASSERT_PARMCOUNT(Current method name:C684; 4; Count parameters:C259))
	...
	OT_PutText($chartID; "dataLine "+String:C10($vl_lineNo)+".type"; "numberedAreaLine")
