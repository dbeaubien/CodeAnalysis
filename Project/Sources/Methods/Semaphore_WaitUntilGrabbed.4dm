...
// 
#DECLARE($semaphoreName : Text; $vl_theDelayBetweenChecks : Integer)
// ----------------------------------------------------
...
If (DEV_ASSERT_PARMCOUNT_RANGE(Current method name:C684; 1; 2; Count parameters:C259))
	...
	var $vh_startTime; $vh_notifyTIme : Time
	...
	While (Semaphore:C143($semaphoreName))
		IDLE:C311
	...
	var $wasGrabbed : Boolean
	$wasGrabbed:=Not:C34(Semaphore:C143($semaphoreName))
End if 
