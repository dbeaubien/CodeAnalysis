...
If (at_XTRA_relativePaths{at_XTRA_relativePaths}#"")
	BEEP:C151
	CONFIRM:C162(Replace string:C233(Localized string:C991("Msg_FLDR_ConfirmDelete"); "%1"; at_XTRA_relativePaths{at_XTRA_relativePaths}); Localized string:C991("Btn_Delete"); Localized string:C991("Btn_Cancel"))
