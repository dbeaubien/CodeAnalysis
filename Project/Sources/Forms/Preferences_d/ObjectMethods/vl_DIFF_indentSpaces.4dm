	...
	: (Form event code:C388=On Data Change:K2:15)
		...
		Case of 
			: (vl_DIFF_indentSpaces<1)
				$vt_msg:=Localized string:C991("Msg_MTHD_MinIndent")  // "The minimum indent must be 1 or higher."
				
			: (vl_DIFF_indentSpaces>10)
				$vt_msg:=Localized string:C991("Msg_MTHD_MaxIndent")  // "The maximum indent must be 10 or less."
